...
$helper=Join-Path $InstallRoot 'afz-openai-agent\tools\Jellyfin-HomeVideos-ApiPreflight.ps1'
...
$diagFile=Join-Path $diagRoot 'JELLYFIN-HOMEVIDEOS-API-PREFLIGHT-LATEST.txt'
