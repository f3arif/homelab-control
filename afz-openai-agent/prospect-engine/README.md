...
- Research: OpenAI Responses API with hosted `web_search_preview`, strict JSON schema, validated no-BOM UTF-8 request bytes, and sanitized upstream request errors
