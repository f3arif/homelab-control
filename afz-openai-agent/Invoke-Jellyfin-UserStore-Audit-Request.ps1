...
$helper=Join-Path $InstallRoot 'afz-openai-agent\tools\Jellyfin-Api-Decoded-State-Audit.ps1'
...
if(-not(Test-Path -LiteralPath $helper -PathType Leaf)){throw "Jellyfin decoded-state audit helper missing: $helper"}
$started=Get-Date
try{
